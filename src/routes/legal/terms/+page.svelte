...
<main class="flex flex-col">
	<div class="w-full bg-base-1">
		<div class="w-main mx-auto mt-64">
			<h1 class="mb-16">Terms and Conditions</h1>
			...
			<ul>
				<li>
					<p>
						...
						by You on any electronic device, named Rezonator
					</p>
				</li>
				<li>
					<p>
						<strong>Application Store</strong> means the digital distribution service operated and developed
						by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application
						has been downloaded.
					</p>
				</li>
				<li>
