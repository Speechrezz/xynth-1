...
<main class='h-full w-full'>
  <div class='bg-base-5 h-full w-full pt-16 bg-[url("/img/LePhonkFireBG.webp")] bg-no-repeat bg-cover lg:bg-contain bg-top'>
    <div class='w-main flex flex-col mx-auto'>
      ...
      <span class='text-lg text-white mx-auto mt-4 drop-shadow-md text-center'>The best distortion you will ever own.</span>
  ...
  <div class='bg-base-5 w-full h-full'>
    <div class='w-main flex flex-col mx-auto'>
      ...
      <div class='flex flex-col w-full mt-32 mb-16'>
      ...
      <div class='flex flex-col justify-center w-full mt-24 mb-32 bg-[url("/img/XynthBigLogo.svg")] bg-no-repeat bg-center pt-10 pb-24 bg-contain'>
